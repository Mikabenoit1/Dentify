...
const Error = () => {
  const [dentPositionX] = useState(new Animated.Value(-60)); // Valeur d'animation pour simuler le surplace
  const [dentPositionY] = useState(new Animated.Value(35)); // Valeur d'animation pour simuler le surplace
  const [soucoupePositionX] = useState(new Animated.Value(-50)); // Valeur d'animation pour déplacer la soucoupe horizontalement
  const [soucoupePositionY] = useState(new Animated.Value(-145)); // Valeur d'animation pour déplacer la soucoupe verticalement
