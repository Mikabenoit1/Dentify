...
// Ajoutez simplement ces deux routes à votre type existant
type ParamList = {
  Profil: undefined;
  NewMdp: undefined;
  ...
  Contact: undefined;
  ProfilClinique: undefined; // Ajouté
  NotificationClinique: undefined; // Ajouté
};
      ...
      items: [
        {
          ...
          action: () => navigation.navigate('ProfilClinique')
        },
        {
      ...
      items: [
        {
          ...
          title: "Notifications",
          action: () => navigation.navigate('NotificationClinique'),
          toggle: (
            <Switch
