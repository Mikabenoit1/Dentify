...
import '../styles/CliniqueEvaluation.css';

const CliniqueEvaluation = () => {
  ...
  return (
    <div className="clinique-avis-container">
      <div className="create-review-section">
        <h2>
          {previewMode ? 'Prévisualisation de l\'avis' : 'Évaluation de la clinique'}
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    placeholder="La clarté des explications reçues, l'accueil du personnel, le professionnalisme de l'équipe, la propreté et confort des installations..."
                    rows="6"
                    required
                  ></textarea>
                </div>
...
export default CliniqueEvaluation;