...
const Profil = () => {
  ...
  const [profile, setProfile] = useState({
    companie: "Clinique de Sourire",
    adresse: "5950 St-Catherine, Montréal, QC H2X 2X9",
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {/* Nom */}
        <Text style={styles.nameLabel}>Companie </Text>
        {isEditing ? (
          <TextInput
            style={styles.input}
            value={profile.companie}
            onChangeText={(text) => handleChange('companie', text)}
          />
        ) : (
          <Text style={styles.name}>{profile.companie}</Text>
        )}
    ...
    <Text style={styles.nameLabel}>Établissement </Text>
        {isEditing ? (
          <TextInput
            style={styles.input}
            value={profile.etablissement}
            onChangeText={(text) => handleChange('etablissement', text)}
          />
        ) : (
          <Text style={styles.infoValue}>{profile.etablissement}</Text>
        )}
        {/* Séparateur */}
